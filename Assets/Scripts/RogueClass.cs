...
{
    public override string classType => "Rogue Class";
    ...
    public int _armorResistance  = 3;
    public int _magicResistance  = 3;
    public int _criticalStrike  = 7;
    ...
    public override float dexterityMultiplier => baseMultiplierDexterity * highPriorityMultiplier;
    public override float intelligenceMultiplier => baseMultiplierIntelligence * lowPriorityMultiplier;
    public override float agilityMultiplier => baseMultiplierAgility * highPriorityMultiplier;
    public override float enduranceMultiplier => baseMultiplierEndurance * mediumPriorityMultiplier;
    ...
    public override float magicResistanceMultiplier => baseMultiplierMagicResistance * lowPriorityMultiplier;
    public override float criticalStrikeMultiplier => baseMultiplierCriticalStrike * highPriorityMultiplier;
